...
int main(int argc, char *argv[])
{
    ...
    const QString apiKey = QString("AAPK542cd28d9fb741d598a3b91c20fa5369icq1jQJFvu1zpTdFu6HFv76z7WRgTa22ZGC0C74QKTo5IvjfpMOqFtVxY3q2DBof");
    if (apiKey.isEmpty())
    {
    ...
    qmlRegisterType<MapQuickView>("Esri.ArcGISTest", 1, 0, "MapView");

    // Register the ArcGISTest (QQuickItem) for QML
    qmlRegisterType<ArcGISTest>("Esri.ArcGISTest", 1, 0, "ArcGISTest");
